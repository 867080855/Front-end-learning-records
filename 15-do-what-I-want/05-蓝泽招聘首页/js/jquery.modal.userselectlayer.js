	...
	$('#J_showmodal_trade').live('click', function() {
			...
			if (multipleValue) {
				for (var i = 0; i < QS_trade.length; i++) {
					if (QS_trade[i].split(',')) {
						...
						htmlTrade += [
								'<li>',
									'<label>',
										'<input class="J_list_trade" type="checkbox" data-code="' + iArray[0] + '" data-title="' + iArray[1] + '"> ',
									'' + iArray[1] + '</label>',
								'</li>',
						].join('');
					};
				...
				for (var i = 0; i < QS_trade.length; i++) {
					if (QS_trade[i].split(',')) {
						...
						htmlTrade += [
								'<li>',
									'<label class="J_list_trade" type="checkbox" data-code="' + iArray[0] + '" data-title="' + iArray[1] + '">',
									'' + iArray[1] + '</label>',
								'</li>',
						].join('');
					};
		...
		function copyTradeSelected() {
	    	...
	    	$('.J_list_trade:checked').each(function(index, el) {
	    		...
	    		htmlListed += [
					'<div class="listed_item_parent J_listed_trade" data-code="' + listedCode + '" data-title="' + listedTitle + '">',
				...
				if (QS_resumetag[i].split(',')) {
					...
					htmlResumetag += [
						'<ul class="list_nav">',
							'<li>',
								'<label>',
									'<input class="J_list_resumetag" type="checkbox" data-code="' + iArray[0] + '" data-title="' + iArray[1] + '"> ',
								'' + iArray[1] + '</label>',
							'</li>',
						'</ul>'
					].join('');
